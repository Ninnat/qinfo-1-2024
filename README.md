...
|||*Linear algebra and axioms of quantum mechanics*: review of finite-dimensional Hilbert spaces; decompositions of linear operators: the spectral, polar, and singular-value decomposition (SVD), operator space and the Bloch sphere; projective measurements; unitary dynamics||NC 2|
