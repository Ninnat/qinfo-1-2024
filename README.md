...
|||*Generalized dynamics and measurements*: generalized measurements (POVMs); measurement models and quantum operations; qubit quantum operations; completely-positive trace-preserving (CPTP) maps; graphical representations of superoperators||NC 8, Pre 3, Ren 5, Bia VI 
